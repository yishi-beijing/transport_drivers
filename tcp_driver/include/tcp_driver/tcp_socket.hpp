...
public:
   ...
   */
  void asyncReceiveHeaderPayload(Functor func_header, Functor func_payload, std::function<void ()> func_finally);
   ...
   * @param func_finally Callback to process after func_payload
   */
  void asyncReceiveHeaderPayloadRetry(std::vector<unsigned char> & buff, Functor func_header, Functor func_payload, std::function<void ()> func_finally);
   ...
   * @param func_finally Callback to process after func_payload
   */
  void asyncSendReceiveHeaderPayload(std::vector<unsigned char> & buff, Functor func_header, Functor func_payload, std::function<void ()> func_finally);
