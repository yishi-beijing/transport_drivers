...
namespace drivers {
    namespace tcp_driver {
        ...
        public:
             ...
             */
            void
            asyncReceiveHeaderPayload(Functor func_header, Functor func_payload, std::function<void()> func_finally);
             ...
             */
            void
            asyncReceiveHeaderPayloadRetry(std::vector<unsigned char> &buff, Functor func_header, Functor func_payload,
             ...
             */
            void
            asyncSendReceiveHeaderPayload(std::vector<unsigned char> &buff, Functor func_header, Functor func_payload,
                                          std::function<void()> func_finally);
